...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { supplier_id: @purchase.supplier_id, value: @purchase.value } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { supplier_id: @purchase.supplier_id, value: @purchase.value } }
